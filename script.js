...
const translations = {
  es: {
    ...
    shopOrderWhatsapp: 'Ordenar por WhatsApp',
    shopOrderInstagram: 'Ordenar por Instagram',
  ...
  en: {
    ...
    shopOrderWhatsapp: 'Order on WhatsApp',
    shopOrderInstagram: 'Order on Instagram',
